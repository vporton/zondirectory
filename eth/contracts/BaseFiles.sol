...
// Items //
    ...
    function pay(uint _itemId, address payable _affiliate, string calldata shippingInfo) external payable returns (bytes memory) {
        ...
        emit Pay(msg.sender, itemOwners[_itemId], _itemId, toAuthor, shippingInfo);
    }
...
/////////////////////////////////////////// Internal //////////////////////////////////////////////
    ...
    event Pay(address indexed payer, address indexed payee, uint indexed itemId, uint256 value, string shippingInfo);
